...
class Contactos(db.Model):
    ...
    historial = db.relationship(
        "Historial", back_populates="contacto", cascade="all, delete-orphan")
    reminders = db.relationship(
        "Reminder", back_populates="contacto", cascade="all, delete-orphan")
...
class Producto(db.Model):
    ...
    termino_busqueda: Mapped[str] = mapped_column(
    ...
    favoritos = db.relationship(
        "Favorite", back_populates="producto", cascade="all, delete-orphan")
    historial = db.relationship(
        "Historial", back_populates="producto", cascade="all, delete-orphan")
...
class User(db.Model):
    ...
    historial = db.relationship(
        "Historial", back_populates="user", cascade="all, delete-orphan")
    reminders = db.relationship(
